 ...
 * Description: Page template for about pages
 */
...
<div class="wrap">
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<div class="content">
				<?php
				if (is_active_sidebar('custom-page-template-sidebar-about') || is_active_sidebar('custom-page-template-sidebar-shared')) { ?>
					<div class="abt-left-panel">
						<?php dynamic_sidebar('custom-page-template-sidebar-about'); ?>
