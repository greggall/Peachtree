<?php
/*
 * Template Name: Custom Urgent Care Template
 * Description: Page template for urgent care pages
 */
		...
		<main id="main" class="site-main" role="main">
			<header class="entry-header">
				<div class="header-title">
                    ...
                    <?php endif;?>
					<h1 class="entry-title"><?php echo __('Urgent Care'); ?></h1>
			...
			<div class="content">
				<?php
				if (is_active_sidebar('custom-page-template-sidebar-urgent-care') || is_active_sidebar('custom-page-template-sidebar-shared')) { ?>
					<div class="abt-left-panel">
						<?php dynamic_sidebar('custom-page-template-sidebar-urgent-care'); ?>
